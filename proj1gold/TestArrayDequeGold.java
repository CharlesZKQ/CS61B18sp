...
//                    "\n Hope to get " + actual + " but got " + expected, expected, actual);
            assertEquals("addFirst(" + i + ")", expected, actual);
...
//                    "\n Hope to get " + actual + " but got " + expected, expected, actual);
            assertEquals("addLast(" + i + ")", expected, actual);
...
//                        "\n Hope to get " + actual + " but got " + expected, expected, actual);
                assertEquals("removeFirst(" + i + ")", expected, actual);
...
//            assertEquals("Something went wrong in addLast()," +
//                    "\n Hope to get " + actual + " but got " + expected, expected, actual);
            assertEquals("removeLast(" + i + ")", expected, actual);
